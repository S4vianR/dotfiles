### BASHRC FOR ARCO LINUX OR ANY ARCH BASED DISTROS ###
### EXPORT ###
export EDITOR='nano'
export VISUAL='nano'
...
#list
alias ls='exa -lh --group-directories-first --color=always --icons'
alias la='exa -lah --group-directories-first --color=always --icons'
alias ll='ls -alFh'
alias l='ls'
alias l.="ls -A | egrep '^\.'"
